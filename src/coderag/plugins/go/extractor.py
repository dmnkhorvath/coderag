...
class GoExtractor(ASTExtractor):
            ...
            if child.type == "type_spec":
                ...
                if type_node.type == "struct_type":
                    ...
                    self._extract_struct_fields(
                        type_node, source, file_path, struct_node.id, qname, nodes, edges, unresolved
                    )
            ...
            if field.type == "field_declaration":
                ...
                if name_node:
                    ...
                    prop_node = Node(
                        ...
                        language="go",
                        docblock=_find_doc_comment(field, source),
            ...
            if spec.type == "const_spec":
                ...
                if name_node:
                    ...
                    const_node = Node(
                        ...
                        language="go",
                        docblock=_find_doc_comment(node, source),
                        source_text=_node_text(spec, source),
                    )
    ...
    def _scan_body_for_calls(
        self, body_node: tree_sitter.Node, source: bytes, caller_id: str, unresolved: list[UnresolvedReference]
    ) -> None:
